...
namespace WiimoteLib
{
	...
	public class Wiimote : IDisposable
	{
		...
		private const int PID    = 0x0306;  // RVL-CNT-01
        private const int PID_TR = 0x0330;  // RVL-CNT-01-TR  2014/10/xx
        ...
        // create a List to hold detected wiimotes
        private static List<Wiimote> wiimotesArray = new List<Wiimote>();
		...
		/// Default constructor
		/// </summary>
        public Wiimote(SafeFileHandle pHandle, int pID)
        {
        ...
        public static List<Wiimote> getWiimotes()
        {
            ...
            while (HIDImports.SetupDiEnumDeviceInterfaces(hDevInfo, IntPtr.Zero, ref guid, index, ref diData))
            {
                ...
                if (HIDImports.SetupDiGetDeviceInterfaceDetail(hDevInfo, ref diData, ref diDetail, size, out size, IntPtr.Zero))
                {
                    ...
                    if (HIDImports.HidD_GetAttributes(mHandle.DangerousGetHandle(), ref attrib))
                    {
                        ...
                        if (attrib.VendorID == VID && (attrib.ProductID == PID || attrib.ProductID == PID_TR))  // 2014/10/xx
                        {
                            found = true;

                            wiimotesArray.Add(new Wiimote(mHandle, id++));
                        }
                        else
                        {
...
//					mWiimoteState.ClassicControllerState.AccelCalibrationInfo.MaxTriggerR = (byte)(buff[15] >> 3);
		...
		///<summary>
		/// Unique identifier for this Wiimote
		///</summary>
		public Guid ID
		{
			get { return mID; }
